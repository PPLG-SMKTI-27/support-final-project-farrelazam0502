...
<td>
  <a href="?action=show&id=<?= $user['id'] ?>">Lihat Detail</a>
</td>
<td>
  <a href="?action=show&id=<?= $user['id'] ?>">Lihat</a> |
  <a href="?action=edit&id=<?= $user['id'] ?>">Edit</a> |
  <a href="?action=delete&id=<?= $user['id'] ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
</td>
</tr>
<?php endforeach; ?>
</table>